...
namespace Game.Kernel
{
	public class SqlServerProvider : IDbProvider
	{
		...
		public DbParameter MakeParam(string paraName, object paraValue, ParameterDirection direction)
		{
			...
			return MakeParam(paraName, paraValue, direction, paraType, null);
		}
		...
		{
			return MakeParam(paraName, paraValue, direction, paraType, sourceColumn, 0);
		}
		...
		public DbParameter MakeParam(string paraName, object paraValue, ParameterDirection direction, Type paraType, string sourceColumn, int size)
		{
			...
			sqlParameter.ParameterName = ParameterPrefix + paraName;
			SqlParameter sqlParameter2 = sqlParameter;
			if (paraType != null)
			{
				sqlParameter2.SqlDbType = (SqlDbType)ConvertToLocalDbType(paraType);
			}
