...
function SelectAllTable(obj, checkboxname) {
    $("input[name='" + checkboxname + "']").prop("checked", obj.checked);
}
//异步提交事件
...
function ajax(method, url, async, callback, fname) {
    var xmlhttp;
