...
namespace Game.Utils
{
	...
	{
		public FrameworkExcption(string message)
			: base(GetException(message))
		{
		}

		public FrameworkExcption(string message, params string[] args)
			: base(GetException(message, args))
		{
		}
